...
const PRESSURE_POTS = [
  ...
  [35, "Hot Start", "Start at x2 and build Multi faster.", "Begin at x2 and gain an extra +0.05 Multi after each successful Crunch.", "Hot Multi growth", { startingRunMultiplier: 2, multiplierStepBonus: 0.05, scoreLabel: "HOT START" }, "HOT", "#ff9f43", "255, 159, 67", "Hard"],
  [36, "Multiplier Rush", "Multi grows +0.1 faster, up to x4.", "Push the run instead of banking early. Every success builds the risky payout faster.", "Fast Multi / cap x4", { multiplierStepBonus: 0.1, multiplierMax: 4, scoreLabel: "MULTI RUSH" }, "X4", "#ffcf4b", "255, 207, 75", "Expert"],
...
const MASTER_POTS = [
  ...
  [56, "Master Pot", "One life. Six seconds. No Suit-only plays.", "Only one- or two-card hands are allowed. Build Multi carefully, bank at streak five, and avoid plain Suit Matches.", "Final mixed rules", { maxLives: 1, turnSeconds: 6, blockedMatchTypes: ["suit"], maxSelection: 2, minBankStreak: 5, scoreMultiplier: 6, multiplierStepBonus: 0.08, multiplierMax: 4, scoreLabel: "MASTER POT" }, "MAX", "#ffe164", "255, 225, 100", "Master"]
].map(([id, title, description, detail, ruleLabel, gameplayModifier, icon, accent, accentRgb, difficulty]) => definePot({

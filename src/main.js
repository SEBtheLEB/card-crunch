import { createGame } from "./gameState.js?v=151";
import { createUI } from "./ui.js?v=151";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=151";
import { adManager } from "./ads.js?v=151";
import { grantShieldToken, hasShieldToken } from "./save.js?v=151";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=151";
import { haptic } from "./haptics.js?v=151";
import { bindInstantAction } from "./input.js?v=151";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=151";
import { installFullscreenControls } from "./fullscreen.js?v=151";
import { bindThemePicker, initializeTheme } from "./themes.js?v=151";
import { initializeCardCollection } from "./cardCollection.js?v=151";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=151";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=151";
import { initializeTutorial } from "./tutorial.js?v=151";

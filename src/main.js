import { createGame } from "./gameState.js?v=154";
import { createUI } from "./ui.js?v=154";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=154";
import { adManager } from "./ads.js?v=154";
import { grantShieldToken, hasShieldToken } from "./save.js?v=154";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=154";
import { haptic } from "./haptics.js?v=154";
import { bindInstantAction } from "./input.js?v=154";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=154";
import { installFullscreenControls } from "./fullscreen.js?v=154";
import { bindThemePicker, initializeTheme } from "./themes.js?v=154";
import { initializeCardCollection } from "./cardCollection.js?v=154";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=154";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=154";
import { initializeTutorial } from "./tutorial.js?v=154";

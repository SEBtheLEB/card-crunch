import { createGame } from "./gameState.js?v=156";
import { createUI } from "./ui.js?v=156";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=156";
import { adManager } from "./ads.js?v=156";
import { grantShieldToken, hasShieldToken } from "./save.js?v=156";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=156";
import { haptic } from "./haptics.js?v=156";
import { bindInstantAction } from "./input.js?v=156";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=156";
import { installFullscreenControls } from "./fullscreen.js?v=156";
import { bindThemePicker, initializeTheme } from "./themes.js?v=156";
import { initializeCardCollection } from "./cardCollection.js?v=156";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=156";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=156";
import { initializeTutorial } from "./tutorial.js?v=156";

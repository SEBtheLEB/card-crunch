import { createGame } from "./gameState.js?v=161";
import { createUI } from "./ui.js?v=161";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=161";
import { adManager } from "./ads.js?v=161";
import { grantShieldToken, hasShieldToken } from "./save.js?v=161";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=161";
import { haptic } from "./haptics.js?v=161";
import { bindInstantAction } from "./input.js?v=161";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=161";
import { installFullscreenControls } from "./fullscreen.js?v=161";
import { bindThemePicker, initializeTheme } from "./themes.js?v=161";
import { initializeCardCollection } from "./cardCollection.js?v=161";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=161";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=161";
import { initializeTutorial } from "./tutorial.js?v=161";

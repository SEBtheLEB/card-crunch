import { createGame } from "./gameState.js?v=163";
import { createUI } from "./ui.js?v=163";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=163";
import { adManager } from "./ads.js?v=163";
import { grantShieldToken, hasShieldToken } from "./save.js?v=163";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=163";
import { haptic } from "./haptics.js?v=163";
import { bindInstantAction } from "./input.js?v=163";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=163";
import { installFullscreenControls } from "./fullscreen.js?v=163";
import { bindThemePicker, initializeTheme } from "./themes.js?v=163";
import { initializeCardCollection } from "./cardCollection.js?v=163";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=163";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=163";
import { initializeTutorial } from "./tutorial.js?v=163";

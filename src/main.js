import { createGame } from "./gameState.js?v=159";
import { createUI } from "./ui.js?v=159";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=159";
import { adManager } from "./ads.js?v=159";
import { grantShieldToken, hasShieldToken } from "./save.js?v=159";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=159";
import { haptic } from "./haptics.js?v=159";
import { bindInstantAction } from "./input.js?v=159";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=159";
import { installFullscreenControls } from "./fullscreen.js?v=159";
import { bindThemePicker, initializeTheme } from "./themes.js?v=159";
import { initializeCardCollection } from "./cardCollection.js?v=159";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=159";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=159";
import { initializeTutorial } from "./tutorial.js?v=159";

import { createGame } from "./gameState.js?v=155";
import { createUI } from "./ui.js?v=155";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=155";
import { adManager } from "./ads.js?v=155";
import { grantShieldToken, hasShieldToken } from "./save.js?v=155";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=155";
import { haptic } from "./haptics.js?v=155";
import { bindInstantAction } from "./input.js?v=155";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=155";
import { installFullscreenControls } from "./fullscreen.js?v=155";
import { bindThemePicker, initializeTheme } from "./themes.js?v=155";
import { initializeCardCollection } from "./cardCollection.js?v=155";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=155";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=155";
import { initializeTutorial } from "./tutorial.js?v=155";

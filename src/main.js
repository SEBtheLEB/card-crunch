import { createGame } from "./gameState.js?v=150";
import { createUI } from "./ui.js?v=150";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=150";
import { adManager } from "./ads.js?v=150";
import { grantShieldToken, hasShieldToken } from "./save.js?v=150";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=150";
import { haptic } from "./haptics.js?v=150";
import { bindInstantAction } from "./input.js?v=150";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=150";
import { installFullscreenControls } from "./fullscreen.js?v=150";
import { bindThemePicker, initializeTheme } from "./themes.js?v=150";
import { initializeCardCollection } from "./cardCollection.js?v=150";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=150";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=150";
import { initializeTutorial } from "./tutorial.js?v=150";

import { createGame } from "./gameState.js?v=162";
import { createUI } from "./ui.js?v=162";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=162";
import { adManager } from "./ads.js?v=162";
import { grantShieldToken, hasShieldToken } from "./save.js?v=162";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=162";
import { haptic } from "./haptics.js?v=162";
import { bindInstantAction } from "./input.js?v=162";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=162";
import { installFullscreenControls } from "./fullscreen.js?v=162";
import { bindThemePicker, initializeTheme } from "./themes.js?v=162";
import { initializeCardCollection } from "./cardCollection.js?v=162";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=162";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=162";
import { initializeTutorial } from "./tutorial.js?v=162";

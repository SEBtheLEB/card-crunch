import { createGame } from "./gameState.js?v=160";
import { createUI } from "./ui.js?v=160";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=160";
import { adManager } from "./ads.js?v=160";
import { grantShieldToken, hasShieldToken } from "./save.js?v=160";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=160";
import { haptic } from "./haptics.js?v=160";
import { bindInstantAction } from "./input.js?v=160";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=160";
import { installFullscreenControls } from "./fullscreen.js?v=160";
import { bindThemePicker, initializeTheme } from "./themes.js?v=160";
import { initializeCardCollection } from "./cardCollection.js?v=160";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=160";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=160";
import { initializeTutorial } from "./tutorial.js?v=160";

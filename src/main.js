import { createGame } from "./gameState.js?v=153";
import { createUI } from "./ui.js?v=153";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=153";
import { adManager } from "./ads.js?v=153";
import { grantShieldToken, hasShieldToken } from "./save.js?v=153";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=153";
import { haptic } from "./haptics.js?v=153";
import { bindInstantAction } from "./input.js?v=153";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=153";
import { installFullscreenControls } from "./fullscreen.js?v=153";
import { bindThemePicker, initializeTheme } from "./themes.js?v=153";
import { initializeCardCollection } from "./cardCollection.js?v=153";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=153";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=153";
import { initializeTutorial } from "./tutorial.js?v=153";

import { createGame } from "./gameState.js?v=152";
import { createUI } from "./ui.js?v=152";
import { calculateCrunchScore, runScoringSelfTests } from "./scoring.js?v=152";
import { adManager } from "./ads.js?v=152";
import { grantShieldToken, hasShieldToken } from "./save.js?v=152";
import { installAudioUnlock, playGameSfx, setAudioSettings } from "./audio.js?v=152";
import { haptic } from "./haptics.js?v=152";
import { bindInstantAction } from "./input.js?v=152";
import { initializePlayGames, showPlayLeaderboard } from "./playGames.js?v=152";
import { installFullscreenControls } from "./fullscreen.js?v=152";
import { bindThemePicker, initializeTheme } from "./themes.js?v=152";
import { initializeCardCollection } from "./cardCollection.js?v=152";
import { initializeCardCollectionUI } from "./cardCollectionUI.js?v=152";
import { bindCardSkinPicker, initializeCardSkin, installRainbowCardTrail } from "./cardSkins.js?v=152";
import { initializeTutorial } from "./tutorial.js?v=152";

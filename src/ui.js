import { formatRunMultiplier, getCrunchPreview } from "./gameState.js?v=79";
import { isPotUnlocked } from "./progression.js?v=79";
import { formatCompactNumber } from "./format.js?v=79";
import { hasShieldToken } from "./save.js?v=79";
